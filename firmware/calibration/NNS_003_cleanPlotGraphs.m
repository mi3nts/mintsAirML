...
versionStr = ['modelVersionNNS_2020_07_23'];
disp(versionStr)
...
for nodeIndex = 1:length(nodeIDs)
    ...
    for targetIndex = 1: length(mintsTargets)              
        ...
        display(newline);
        trainFig             = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_trainCleanPlot");
        validFig             = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_validCleanPlot");
        combinedFig          = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_combinedCleanPlot");
        allInOneFig          = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_allInOneCleanPlot");
        predictFig           = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_predictorCleanPlot");
        trainQQFig           = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_trainQQCleanPlot");
        validQQFig           = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_validQQCleanPlot");
        combinedQQFig        = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_combinedQQCleanPlot");
        allInOneQQFig        = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_allInOneQQCleanPlot");
        residuesFigTrain     = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_trainCleanResidues");
        residuesFigTest      = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_testCleanResidues") ;
        residuesHistFigTrain = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_trainHistCleanResidues");
        residuesHistFigTest  = getMintsFileNameFigPre(plotsFolder,nodeIDs,nodeIndex,target,versionStr +"_testHistCleanResidues") ;                       
        ...
        %% Cleaning Data 
%         
%         Out_Train(outTrainEstimate<0) = [];
%         outTrainEstimate(outTrainEstimate<0) = [];
        cutParamTrain = abs(outTrainEstimate-Out_Train)> cleanCut{targetIndex};
        Out_Train(cutParamTrain) = [];
        outTrainEstimate(cutParamTrain) = [];
        
        
%         Out_Validation(outValidEstimate<0) = [];
%         outValidEstimate(outValidEstimate<0) = [];
        cutParamValid = abs(outValidEstimate-Out_Validation)> cleanCut{targetIndex};
        Out_Validation(cutParamValid) = [];
        outValidEstimate(cutParamValid) = [];
...
%                                 
        drawScatterPlotMintsLimits([Out_Train;Out_Validation],...
         ...
         drawScatterPlotMintsCombinedLimits(Out_Train,...
                                         ...
                                         unit,...
                                         allInOneFig); 
%% Nueral Network Doesnt Give out Predictor Inportaince      
...
%                                             nodeID,predictFig) ;                               
      ...
      clearvars -except...
               ...
               targetUnits gapsX gapsY cleanCut
