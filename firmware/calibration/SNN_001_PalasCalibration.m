...
[ref,pcUser] = system('hostname');

if(strtrim(string(pcUser)) == "TeamLary1")
    mintsDataFolder         = "/media/teamlary/Team_Lary_2/air930/mintsData/";
    poolobj = parpool(12)
...
rawMatsFolder            = mintsDataFolder + "rawMats/";

mergedMatsFolder         = mintsDataFolder + "mergedMats/";

trainingMatsFolder       = mintsDataFolder + "trainingMats";

modelsMatsFolder         = mintsDataFolder + "modelsMats";
...
versionStr = ['modelVersionSNNS_' datestr(today,'yyyy_mm_dd')];
disp(versionStr)
