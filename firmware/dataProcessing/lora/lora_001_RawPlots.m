...
plotsFolder        =  dataFolder + "/loraPlots";
...
for loraIDIndex = 1:length(loraIDs)
    ...
    if isfile(loadName)
        ...
        display(strcat("No Data Recorder for Node:",loraID));
    end
...
%     
    ...
    Fig_name = strcat(saveFolder, "/loraMints_",nodeID, '.png');
...
%     
    ...
    Fig_name = strcat(saveFolder, "/loraMints_LPO1_",nodeID, '.png');
        mkdir(fileparts(Fig_name));
    saveas(figure_1,char(Fig_name));
...
%     
    ...
    Fig_name = strcat(saveFolder, "/loraMints_LPO2_",nodeID, '.png');
        mkdir(fileparts(Fig_name));
    saveas(figure_1,char(Fig_name));
